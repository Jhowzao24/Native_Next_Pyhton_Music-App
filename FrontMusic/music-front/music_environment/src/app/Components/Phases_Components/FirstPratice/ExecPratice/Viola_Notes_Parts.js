...
import { Modal, Button, Col, Divider, Tooltip, Card, Card, Steps} from 'antd';
            ...
            <Modal
                ...
                <Card sx={style}>
                    ...
                    <Col style={{paddingLeft: '50px'}}>
                        <Steps style={{color: 'aqua'}}>Positions</Steps>
                    </Col><Divider/><br/>
                        ...
                        <Button>
                            <details style={{fontSize: '5px'}}><summary><img style={{width: '100px', height: '100px', borderRadius: '50px'}} src='https://consordini.com/wp-content/uploads/2016/01/viola-and-violin.jpg' alt='violadesc'/></summary>
                                <Card style={{width: '600px', height: '270px', fontSize: '12px'}}>
                                    ...
                                    <Divider/>
                                    <Col style={{float: 'left', paddingLeft: '40px'}}>
                                    <Card style={{backgroundColor: 'blue'}}>
                                    ...
                                    <Col style={{float: 'left', paddingLeft: '20px'}}>
                                    <Card style={{backgroundColor: 'blue'}}>
                                    ...
                                    <Col style={{float: 'left', paddingLeft: '150px'}} span={5}>
                    ...
                    <Col style={{paddingLeft: '750px'}} span={12}>
                        <Steps>Notes Positions</Steps>
                    </Col>
                    <Col style={{paddingLeft: '700px', paddingTop: '30px'}} span={0}>
                    <Card>
                        <Button>
                            <details style={{fontSize: '5px'}}><summary><img style={{width: '120px', height: '120px', borderRadius: '100px'}} src='https://th.bing.com/th/id/OIP.YbZ8Xjvn_lsvGabs8ckw0wHaEj?pid=ImgDet&rs=1' alt='notasviola'/></summary>
                                <Card style={{width: '500px', height: '800px'}}>
                                    ...
                                    <Col style={{paddingLeft: '150px'}} span={5}>
                                    ...
                                    <Col style={{paddingLeft: '205px'}} span={5}>
                                    ...
                                    <Col style={{paddingLeft: '260px'}} span={5}>
                                    ...
                                    <Col style={{paddingLeft: '70px'}} span={0.8}>
                                    ...
                                    <Col style={{paddingLeft: '74px'}} span={4}>
                                    ...
                                    <Col style={{paddingLeft: '130px'}} span={4}>
                                    ...
                                    <Col style={{paddingLeft: '150px'}} span={4}>
                                    ...
                                    <Col style={{paddingLeft: '185px'}} span={4}>
                                    ...
                                    <Col style={{paddingLeft: '205px'}} span={4}>
                                    ...
                                    <Col style={{paddingLeft: '245px'}} span={4}>
                                    ...
                                    <Col style={{paddingLeft: '266px'}} span={4}>
                                    ...
                                    <Col style={{paddingLeft: '69px'}} span={2}>
                                    ...
                                    <Col style={{paddingLeft: '140px'}} span={4}>
                                    ...
                                    <Col style={{paddingLeft: '195px'}} span={4}>
                                    ...
                                    <Col style={{paddingLeft: '255px'}} span={4}>
                                    ...
                                    <Col style={{paddingLeft: '57px'}} span={2}>
                                    ...
                                    <Col style={{paddingLeft: '95px'}} span={4}>
                                        <Tooltip title='RÉ#/Segundo dedo!'>
                                            <p style={{backgroundColor: 'blue', color: 'white', width: '18px', height: '18px', borderRadius: '20px', fontSize: '7px'}}>RÉ/#</p>
                                        </Tooltip>
                                    </Col>
                                    <Col style={{paddingLeft: '128px'}} span={4}>
                                    ...
                                    <Col style={{paddingLeft: '67px'}} span={2}>
                                    ...
                                    <Col style={{paddingLeft: '265px'}} span={4}>
                                    ...
                                    <Col style={{paddingLeft: '92px'}} span={4}>
                                    ...
                                    <Col style={{paddingLeft: '184px'}} span={4}>
                                        <Tooltip title='SOL#/Quarto dedo com espaço de 1/2 tom da nota anterior'>
                                            <p style={{backgroundColor: 'blue', color: 'white', width: '18px', height: '18px', borderRadius: '20px', fontSize: '7px'}}>SOL#</p>
                                        </Tooltip>
                                    </Col>
                                    <Col style={{paddingLeft: '204px'}} span={4}>
                                    ...
                                    <Col style={{paddingLeft: '93px'}} span={4}>
                                    ...
                                    <Col style={{paddingLeft: '197px'}} span={4}>
                                    ...
                                    <Col style={{paddingLeft: '210px'}} span={4}>
                                    ...
                                    <Col style={{paddingLeft: '267px'}} span={4}>
                                    ...
                                    <Col style={{paddingLeft: '257px'}} span={4}>
                                    ...
                                    <Col style={{paddingLeft: '247px'}} span={4}>
                                    ...
                                    <Col style={{paddingLeft: '590px'}} span={39}>
                                    ...
                                    <Col style={{paddingLeft: '280px', paddingTop: '80px'}} span={0}>
                                    ...
                                    <Col style={{paddingLeft: '80px'}} span={13}>
                                    ...
                                    <Col style={{paddingTop: '106px'}} span={0}>
                                    ...
                                    <Col style={{paddingTop: '90px', paddingRight: '170px'}}>
